...
public class SwitchConnection implements AutoCloseable {
    ...
    public SwitchConnection(String ip, int port) throws UnknownHostException, IOException {
        this.ip = ip;
        this.port = port;
        this.connection = new Socket(ip, port);
    }

    public void createConnection(HsmCommand command) throws IOException {
